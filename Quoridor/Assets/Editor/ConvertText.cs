...
class ConvertText : EditorWindow
{
    ...
    public static void TextMeshTransmorphSingle(MenuCommand command)
    {
        ...
        TMP_FontAsset newFont = Resources.Load("Fonts/Neat Chalk Padded SDF", typeof(TMP_FontAsset)) as TMP_FontAsset;
        if (newFont == null)
        {
        ...
        fontMap.Add("Neat Chalk", newFont);


        Font font = currentUIText.font;
        if (font.fontNames[0] != "Neat Chalk")
            return;
    ...
    [MenuItem("Tools/TMPro Utils/Convert all selected Chalk Text -> TextMeshUGUI ")]
    public static void TextMeshTransmorphMultipleChalk(MenuCommand command)
    {
        TMP_FontAsset newFont = Resources.Load("Fonts/Neat Chalk Padded SDF", typeof(TMP_FontAsset)) as TMP_FontAsset;
        if (newFont == null)
        {
        ...
        var selections = Selection.objects.GetEnumerator();
        Text currentUIText;
        ...
        do
        {
            var currentGO = (GameObject)selections.Current;
            currentUIText = currentGO.GetComponent<Text>();
            Font font = currentUIText.font;
    ...
    [MenuItem("Tools/TMPro Utils/Convert all selected Handlee Text -> TextMeshUGUI ")]
    public static void TextMeshTransmorphMultipleHandlee(MenuCommand command)
    {
        TMP_FontAsset newFont = Resources.Load("Fonts/Handlee SDF", typeof(TMP_FontAsset)) as TMP_FontAsset;
        if (newFont == null)
        {
            Debug.Log("Not so awesome...");
            return;
    ...
    [MenuItem("Tools/TMPro Utils/Convert all Chalk Texts -> TextMeshUGUI ")]
    ...
    [MenuItem("Tools/TMPro Utils/Convert all Handlee Texts -> TextMeshUGUI ")]
    public static void TextMeshTransmorphAllHandlee(MenuCommand command)
    {
        Text[] texts = FindObjectsOfType<Text>();
